...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'visionlouisville_vision', 'tweet_id',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'Reply.tweet_id'
        db.add_column(u'visionlouisville_reply', 'tweet_id',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vision.tweet_id'
        db.delete_column(u'visionlouisville_vision', 'tweet_id')

        # Deleting field 'Reply.tweet_id'
        db.delete_column(u'visionlouisville_reply', 'tweet_id')
