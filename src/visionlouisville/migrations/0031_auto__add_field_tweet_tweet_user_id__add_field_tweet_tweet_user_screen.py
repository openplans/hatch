...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.tweet_user_id'
        db.add_column(u'visionlouisville_tweet', 'tweet_user_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Tweet.tweet_user_screen_name'
        db.add_column(u'visionlouisville_tweet', 'tweet_user_screen_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tweet.tweet_user_id'
        db.delete_column(u'visionlouisville_tweet', 'tweet_user_id')

        # Deleting field 'Tweet.tweet_user_screen_name'
        db.delete_column(u'visionlouisville_tweet', 'tweet_user_screen_name')
