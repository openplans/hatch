...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Reply'
        db.create_table(u'visionlouisville_reply', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('vision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='replies', to=orm['visionlouisville.Vision'])),
        ...
        db.send_create_signal(u'visionlouisville', ['Reply'])


    def backwards(self, orm):
        # Deleting model 'Reply'
        db.delete_table(u'visionlouisville_reply')
