...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reply.text'
        db.alter_column(u'visionlouisville_reply', 'text', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Reply.text'
        db.alter_column(u'visionlouisville_reply', 'text', self.gf('django.db.models.fields.CharField')(max_length=140))
