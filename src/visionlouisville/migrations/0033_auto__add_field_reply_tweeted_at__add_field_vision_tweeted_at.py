...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reply.tweeted_at'
        db.add_column(u'visionlouisville_reply', 'tweeted_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Vision.tweeted_at'
        db.add_column(u'visionlouisville_vision', 'tweeted_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reply.tweeted_at'
        db.delete_column(u'visionlouisville_reply', 'tweeted_at')

        # Deleting field 'Vision.tweeted_at'
        db.delete_column(u'visionlouisville_vision', 'tweeted_at')
