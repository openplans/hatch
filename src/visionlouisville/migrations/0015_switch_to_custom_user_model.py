...
class Migration(SchemaMigration):
    """
    Adapted from this excellent Stack Overflow anwer:
    ...
    def forwards(self, orm):
        ...
        db.rename_table('auth_user_user_permissions', 'visionlouisville_user_user_permissions')

    def backwards(self, orm):
        db.rename_table('visionlouisville_user', 'auth_user')
        db.rename_table('visionlouisville_user_groups', 'auth_user_groups')
        db.rename_table('visionlouisville_user_user_permissions', 'auth_user_user_permissions')
