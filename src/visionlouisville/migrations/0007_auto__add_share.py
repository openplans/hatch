...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Share'
        db.create_table(u'visionlouisville_share', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vision', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['visionlouisville.Vision'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shares', to=orm['auth.User'])),
            ('tweet_id', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
        ))
        db.send_create_signal(u'visionlouisville', ['Share'])

        # Adding M2M table for field sharers on 'Vision'
        m2m_table_name = db.shorten_name(u'visionlouisville_vision_sharers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vision', models.ForeignKey(orm[u'visionlouisville.vision'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'visionlouisville_share')

        # Removing M2M table for field sharers on 'Vision'
        db.delete_table(db.shorten_name(u'visionlouisville_vision_sharers'))
    ...
    models = {
        ...
        u'visionlouisville.vision': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sharers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'sharers'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
