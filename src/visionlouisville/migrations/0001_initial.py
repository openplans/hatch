...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'auth_user', (
            ...
            ('groups', self.gf('django.db.models.fields.related.ManyToManyField')(**{'to': orm['auth.Group'], 'symmetrical': False, 'blank': True})),
            (u'id', self.gf('django.db.models.fields.AutoField')(**{'primary_key': True})),
            ...
            ('user_permissions', self.gf('django.db.models.fields.related.ManyToManyField')(**{'to': orm['auth.Permission'], 'symmetrical': False, 'blank': True})),
