...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vision.featured'
        db.add_column(u'visionlouisville_vision', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vision.featured'
        db.delete_column(u'visionlouisville_vision', 'featured')
