...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vision.media_url'
        db.add_column(u'visionlouisville_vision', 'media_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vision.media_url'
        db.delete_column(u'visionlouisville_vision', 'media_url')
