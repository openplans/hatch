...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'visionlouisville_support')

        # Adding M2M table for field supporters on 'Vision'
        m2m_table_name = db.shorten_name(u'visionlouisville_vision_supporters')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'visionlouisville_support', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='support', to=orm['visionlouisville.Vision'])),
            ('supporter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='support', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'visionlouisville', ['Support'])

        # Removing M2M table for field supporters on 'Vision'
        db.delete_table(db.shorten_name(u'visionlouisville_vision_supporters'))
    ...
    models = {
        ...
        u'visionlouisville.vision': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'supporters': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'supporters'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
