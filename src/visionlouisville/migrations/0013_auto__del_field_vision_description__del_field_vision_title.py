...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Vision.description'
        db.delete_column(u'visionlouisville_vision', 'description')

        # Deleting field 'Vision.title'
        db.delete_column(u'visionlouisville_vision', 'title')


    def backwards(self, orm):
        # Adding field 'Vision.description'
        db.add_column(u'visionlouisville_vision', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Vision.title'
        db.add_column(u'visionlouisville_vision', 'title',
    ...
    models = {
        ...
        u'visionlouisville.vision': {
            ...
            'sharers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'sharers'", 'blank': 'True', 'through': u"orm['visionlouisville.Share']", 'to': u"orm['auth.User']"}),
            'supporters': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'supported'", 'blank': 'True', 'to': u"orm['auth.User']"}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'tweet_id': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        }
