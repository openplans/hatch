...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.sm_not_found'
        db.add_column(u'visionlouisville_user', 'sm_not_found',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.sm_not_found'
        db.delete_column(u'visionlouisville_user', 'sm_not_found')
