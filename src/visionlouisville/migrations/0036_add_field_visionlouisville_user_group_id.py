...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.groups.through.id'
        db.add_column(u'visionlouisville_user_groups', 'id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'User.user_permissions.through.id'
        db.add_column(u'visionlouisville_user_user_permissions', 'id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'User.groups.through.id'
        db.delete_column(u'visionlouisville_user_groups', 'id')

        # Deleting field 'User.user_permissions.through.id'
        db.delete_column(u'visionlouisville_user_user_permissions', 'id')
