...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.visible_on_home'
        db.add_column(u'visionlouisville_user', 'visible_on_home',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.visible_on_home'
        db.delete_column(u'visionlouisville_user', 'visible_on_home')
