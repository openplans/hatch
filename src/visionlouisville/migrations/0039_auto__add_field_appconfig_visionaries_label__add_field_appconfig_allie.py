...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppConfig.visionaries_label'
        db.add_column(u'visionlouisville_appconfig', 'visionaries_label',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppConfig.allies_label'
        db.add_column(u'visionlouisville_appconfig', 'allies_label',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppConfig.visionaries_label'
        db.delete_column(u'visionlouisville_appconfig', 'visionaries_label')

        # Deleting field 'AppConfig.allies_label'
        db.delete_column(u'visionlouisville_appconfig', 'allies_label')
