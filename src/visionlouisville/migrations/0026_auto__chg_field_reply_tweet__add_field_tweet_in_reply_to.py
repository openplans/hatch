...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reply.tweet'
        db.alter_column(u'visionlouisville_reply', 'tweet_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, unique=True, to=orm['visionlouisville.Tweet']))
        # Adding field 'Tweet.in_reply_to'
        db.add_column(u'visionlouisville_tweet', 'in_reply_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='tweet_replies', null=True, to=orm['visionlouisville.Tweet']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Reply.tweet'
        db.alter_column(u'visionlouisville_reply', 'tweet_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['visionlouisville.Tweet']))
        # Deleting field 'Tweet.in_reply_to'
        db.delete_column(u'visionlouisville_tweet', 'in_reply_to_id')
    ...
    models = {
        ...
        u'visionlouisville.tweet': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'in_reply_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tweet_replies'", 'null': 'True', 'to': u"orm['visionlouisville.Tweet']"}),
