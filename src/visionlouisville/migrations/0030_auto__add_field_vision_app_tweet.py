...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vision.app_tweet'
        db.add_column(u'visionlouisville_vision', 'app_tweet',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='app_tweeted_vision', unique=True, null=True, to=orm['visionlouisville.Tweet']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vision.app_tweet'
        db.delete_column(u'visionlouisville_vision', 'app_tweet_id')
    ...
    models = {
        ...
        u'visionlouisville.vision': {
            ...
            'app_tweet': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'app_tweeted_vision'", 'unique': 'True', 'null': 'True', 'to': u"orm['visionlouisville.Tweet']"}),
