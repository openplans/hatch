...
from .views import (
    app_view, api_router, current_user_api_view, input_stream_api_view, 
    share_api_view, support_api_view, unsupport_api_view, vision_instance_view)
...
urlpatterns = patterns('',
    ...
    url(r'^api/stream/$', input_stream_api_view,
        name='input-stream'),
