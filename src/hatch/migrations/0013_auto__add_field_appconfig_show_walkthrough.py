...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppConfig.show_walkthrough'
        db.add_column(u'hatch_appconfig', 'show_walkthrough',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppConfig.show_walkthrough'
        db.delete_column(u'hatch_appconfig', 'show_walkthrough')
    ...
    models = {
        ...
        u'hatch.appconfig': {
            ...
            'show_walkthrough': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
