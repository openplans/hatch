...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppConfig.walkthrough_title_1'
        db.add_column(u'hatch_appconfig', 'walkthrough_title_1',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppConfig.walkthrough_description_1'
        db.add_column(u'hatch_appconfig', 'walkthrough_description_1',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppConfig.walkthrough_title_2'
        db.add_column(u'hatch_appconfig', 'walkthrough_title_2',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppConfig.walkthrough_description_2'
        db.add_column(u'hatch_appconfig', 'walkthrough_description_2',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppConfig.walkthrough_title_3'
        db.add_column(u'hatch_appconfig', 'walkthrough_title_3',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppConfig.walkthrough_description_3'
        db.add_column(u'hatch_appconfig', 'walkthrough_description_3',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppConfig.walkthrough_title_1'
        db.delete_column(u'hatch_appconfig', 'walkthrough_title_1')

        # Deleting field 'AppConfig.walkthrough_description_1'
        db.delete_column(u'hatch_appconfig', 'walkthrough_description_1')

        # Deleting field 'AppConfig.walkthrough_title_2'
        db.delete_column(u'hatch_appconfig', 'walkthrough_title_2')

        # Deleting field 'AppConfig.walkthrough_description_2'
        db.delete_column(u'hatch_appconfig', 'walkthrough_description_2')

        # Deleting field 'AppConfig.walkthrough_title_3'
        db.delete_column(u'hatch_appconfig', 'walkthrough_title_3')

        # Deleting field 'AppConfig.walkthrough_description_3'
        db.delete_column(u'hatch_appconfig', 'walkthrough_description_3')
    ...
    models = {
        ...
        u'hatch.appconfig': {
            ...
            'walkthrough_description_1': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'walkthrough_description_2': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'walkthrough_description_3': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'walkthrough_title_1': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'walkthrough_title_2': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'walkthrough_title_3': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'})
        },
        u'hatch.category': {
