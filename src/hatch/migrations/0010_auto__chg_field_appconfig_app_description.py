...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AppConfig.app_description'
        db.alter_column(u'hatch_appconfig', 'app_description', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'AppConfig.app_description'
        db.alter_column(u'hatch_appconfig', 'app_description', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
