...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AppConfig.name'
        db.delete_column(u'hatch_appconfig', 'name')

        # Adding field 'AppConfig.app_label'
        db.add_column(u'hatch_appconfig', 'app_label',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppConfig.app_description'
        db.add_column(u'hatch_appconfig', 'app_description',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


        # Changing field 'AppConfig.twitter_tracking_keywords'
        db.alter_column(u'hatch_appconfig', 'twitter_tracking_keywords', self.gf('django.db.models.fields.TextField')(max_length=1024))

    def backwards(self, orm):
        # Adding field 'AppConfig.name'
        db.add_column(u'hatch_appconfig', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Unused Site Name', max_length=50),
                      keep_default=False)

        # Deleting field 'AppConfig.app_label'
        db.delete_column(u'hatch_appconfig', 'app_label')

        # Deleting field 'AppConfig.app_description'
        db.delete_column(u'hatch_appconfig', 'app_description')


        # Changing field 'AppConfig.twitter_tracking_keywords'
        db.alter_column(u'hatch_appconfig', 'twitter_tracking_keywords', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'hatch.appconfig': {
            ...
            'app_description': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
