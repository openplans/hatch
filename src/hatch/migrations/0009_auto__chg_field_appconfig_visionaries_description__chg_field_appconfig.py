...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AppConfig.visionaries_description'
        db.alter_column(u'hatch_appconfig', 'visionaries_description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'AppConfig.allies_description'
        db.alter_column(u'hatch_appconfig', 'allies_description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'AppConfig.visionaries_description'
        db.alter_column(u'hatch_appconfig', 'visionaries_description', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'AppConfig.allies_description'
        db.alter_column(u'hatch_appconfig', 'allies_description', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
