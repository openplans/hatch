...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Share.tweet'
        db.delete_column(u'hatch_share', 'tweet_id')


    def backwards(self, orm):
        # Adding field 'Share.tweet'
        db.add_column(u'hatch_share', 'tweet',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['hatch.Tweet']),
                      keep_default=False)
