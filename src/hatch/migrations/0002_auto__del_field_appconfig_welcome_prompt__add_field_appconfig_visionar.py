...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AppConfig.welcome_prompt'
        db.delete_column(u'hatch_appconfig', 'welcome_prompt')

        # Adding field 'AppConfig.visionaries_description'
        db.add_column(u'hatch_appconfig', 'visionaries_description',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppConfig.allies_description'
        db.add_column(u'hatch_appconfig', 'allies_description',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AppConfig.welcome_prompt'
        db.add_column(u'hatch_appconfig', 'welcome_prompt',
                      self.gf('django.db.models.fields.CharField')(default='Welcome!', max_length=1024),
                      keep_default=False)

        # Deleting field 'AppConfig.visionaries_description'
        db.delete_column(u'hatch_appconfig', 'visionaries_description')

        # Deleting field 'AppConfig.allies_description'
        db.delete_column(u'hatch_appconfig', 'allies_description')
