...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Share.retweet_id'
        db.add_column(u'hatch_share', 'retweet_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Share.retweet_id'
        db.delete_column(u'hatch_share', 'retweet_id')
    ...
    models = {
        ...
        u'hatch.share': {
            ...
            'tweet': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['hatch.Tweet']"}),
